...
画法：左侧输入，中间夜航猫头鹰或怪机器处理，右侧输出，橙色箭头表达主流向。

### 系统局部

适合：信息来源、过滤器、数据库、渲染器、agent 系统局部。

画法：只画 3-5 个核心模块，夜航猫头鹰参与其中一个关键动作。

### 前后对比

适合：混乱/有序，手动/自动，分散/收拢，焦虑/稳定。

画法：左混乱，右稳定，中间橙色箭头。角色可以在中间处理、校准或删减。

### 角色状态

适合：用户痛点、创作者状态、工具太多、信息焦虑、卡住到跑起来。

画法：2-4 个小状态，每个状态一个短标注。猫头鹰不要重复成表情包。
...
画法：一层层盒子，不要正式金字塔；猫头鹰在旁边搬砖、递稿、守门或校准。

### 地图路线

适合：从想法到上线、用户路径、内容承接路径、学习路线。

画法：一条弯曲路径，少量节点，猫头鹰牵线、端咖啡或走路。

### 小漫画分镜

适合：失败到成功、真实过程、吐槽、使用前后变化。

画法：2-4 个小场景，每格只表达一个动作。保持留白，不要变成连环画海报。
...
3. 让夜航猫头鹰承担动作：不是站旁边，而是卡在机器里、拉错线、守门、搬运、修补、称重、扶梯子、记录、把东西塞进某个怪装置。

### 可用物件池

- 纸箱、抽屉、旧机器、漏斗、秤、邮筒、门、井、梯子、水管、线团、闸门、转盘、黑盒、打孔器、压面机、晾衣绳、怪工位。
- 用时只选 1-2 个，不要堆满。
- 不要默认使用船、灯塔、码头、海浪、星月、航线、船锚、海图等物件；只有正文明确提到时才可以使用。
...
同类主题也要换新隐喻。例如“承接路径”不一定画路线，可以画角色把内容尾巴接到门把手；“一鱼多吃”不一定画鱼，可以画角色把一个纸团压成几种形状。
